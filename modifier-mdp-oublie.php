     ...
     // Etape 1 : connexion au serveur de base de données
        ...
        if(!empty($_POST['mdpconnect']) AND !empty($_POST['mdp2'])) {
			...
			if($ligne != false) {
				...
				$erreur = "Mauvais code de vérification !";
			}
        } else {
            ...
            <div class="compte2">
                <div class="nav-compte">
                    ...
                    <div class="onglets-nav">
                        <img src="images/profil/coeur-vide.png" alt="coeur de suivi">
                        <p><a class="btn-lien-page btn-lien-pause" href="suivis.php"> Créateurs suivis</a></p>
                    </div>
                    <div class="onglets-nav">
                        <img src="images/profil/bulle-comment.png" alt="bulle de commentaire">
                        <p><a class="btn-lien-page btn-lien-pause" href="commentaires.php">Commentaires laissés</a></p>
                    </div>
                    <div class="onglets-nav">
                        <img src="images/profil/deconnexion.png" alt="flèche de déconnexion">
                        <p><a class="btn-lien-page btn-lien-stop" href="deconnexion.php">Déconnexion</a></p>
                    </div>
                </div>
                <div>
                    <form action="" method="post" class="form-modifier-compte">
                        <div class="champs grande-zone">
                            <label for="mdpconnect"><strong>Code de vérification</strong></label>
                            <input type="password" name="mdpconnect" id="mdpconnect" spellcheck="false" value="<?php echo($_SESSION['mdpUser'])?>" >
                        </div>
                        <div class="champs grande-zone">
                            <label for="mdp2"><strong>Nouveau mot de passe</strong></label>
                            <input type="password" name="mdp2" id="mdp2" spellcheck="false" placeholder="***********">
                        </div>
                        <div>
                            <label for="verifMdp"></label>
                            <input type="submit" name="verifMdp" id="verifMdp" value="Enregistrer" class="btn-envoyer">
                        </div>
                    </form>
                    <?php
		if(isset($erreur)) {
